...
const App = {
  ...
  async init() {
    ...
    // Apply saved theme early (no flash)
    this.applyTheme();
    ...
    document.getElementById("nav-home")?.addEventListener("click", () => { setActive("nav-home-btn"); Router.go("/"); });
    document.getElementById("nav-home-btn")?.addEventListener("click", () => { setActive("nav-home-btn"); Router.go("/"); closeSidebar(); });
    document.getElementById("nav-ref")?.addEventListener("click", () => { setActive("nav-ref"); Router.go("/ref"); closeSidebar(); });
    document.getElementById("nav-review")?.addEventListener("click", () => { setActive("nav-review"); Router.go("/review"); closeSidebar(); });
    document.getElementById("nav-stats")?.addEventListener("click", () => { setActive("nav-stats"); Router.go("/stats"); closeSidebar(); });
    document.getElementById("nav-home-mobile")?.addEventListener("click", () => { setActive("nav-home-btn"); Router.go("/"); });
